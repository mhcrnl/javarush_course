    ...
    public static void sort(final List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>()
        {
            public int compare(Stock stock1, Stock stock2)
            {
                ...
                double priceChange1 = (double) stock1.get("last") - (double) stock1.get("open");
                double priceChange2 = (double) stock2.get("last") - (double) stock2.get("open");
                result = Double.compare(priceChange2, priceChange1);
